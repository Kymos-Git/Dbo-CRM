        ...
        {filters.map((filter) => (
          ...
          >
            <label
              ...
              style={{ flexShrink: 0 }}
            >
              <span className="ft-label-text text-[var(--primary)]">{filter.label}</span>
            </label>
            ...
            {filter.type === "text" && (
              <input
                ...
                className="ft-input w-full p-2 border-b-1 border-b-gray-400 text-s leading-snug focus:outline-none focus:shadow-md text-[var(--text)] focus:border-b-1 focus:border-[var(--primary)]"
                style={{ minHeight: 32 }}
              />
            )}
            ...
            {filter.type === "select" && (
              <select
                ...
                defaultValue={values[filter.name]}
                onBlur={(e) => handleBlur(filter.name, e.target.value)}
                className="ft-select w-full p-2 border-b-1 border-b-gray-400 text-s leading-snug focus:outline-none focus:shadow-md text-[var(--text)] fill-[var(--bg-alt)] focus:border-b-1 focus:border-[var(--primary)] "
                style={{ minHeight: 32 }}
              >
